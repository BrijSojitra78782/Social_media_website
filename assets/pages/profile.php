...
if(!checkBS($profile['id'])){
    ?>
                <div class="d-flex gap-2 align-items-center my-3">
                    <!-- 4 -->
                    <a class="btn btn-sm btn-primary"><i class="bi bi-file-post-fill"></i> <?=count($profile_post)?>
                        Posts</a>
                    <a class="btn btn-sm btn-primary <?=count($profile['followers'])<1?'disabled':''?>"
                        ...
                        <?=count($profile['followers'])?> Followers</a>
                    <a class="btn btn-sm btn-primary <?=count($profile['following'])<1?'disabled':''?>"
                        ...
                        <?=count($profile['following'])?> Following</a>
        ...
        <div class="modal fade" id="postview<?=$post['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                ...
                ?>
                            ...
                            <div class="border-bottom p-2 <?=$post['post_text']?'':'d-none'?>"><?=$post['post_text']?>
                            </div>
